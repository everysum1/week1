...
treasureChest.unshift('rubber band');
console.log(treasureChest);
...
var trex = {
  type: 'dinosaur',
  collects: ['bugs', 'toothpicks', 'arms'],
  canFly: false
}

var bigfoot = {
  type: 'sasquatch',
  collects: ['backscratchers', 'honey', 'jordans'],
  canFly: false
}

var pegasus = {
  type: 'unicorn',
  collects: ['rainbows', 'fairies', 'leprachauns'],
  canFly: true
}
...
grandCouncil.push(trex);
grandCouncil[1] = bigfoot;
