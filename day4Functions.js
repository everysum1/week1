...
//console.log('item is set equal to what the user passed into us:', item);
item = prompt("What would you like the computer to say?");
speak(item);
  ...
  //it will print a one word string "item"
...
var speak = function(val) {
  console.log('the value being passed is: ' + val);
}
...
var climbHalfDome = function() {
  console.log('Yay, congrats on climbing such an awesome rock!' + item);
};
...
var add5Return = function (singlenum) {
  return singlenum + 5;
}
...
add5SideEffect();
  ...
  //. Now what do you see in your console? add5SideEffect worked! It had a side effect, in this case changing a variable available in the global scope. 
...
var interestedVar = prompt("what is your favorite animal?", 'quackit.com');
...
function animalMaker(imputType, imputSuperPower, imputCanFly) {
    this.type = imputType,
    this.superPower = imputSuperPower,
    this.canFly = imputCanFly,
    this.createdBy = 'izzy'
  }

var createdAnimal = new animalMaker('red panda','being ridiculously cute',false);
console.log(createdAnimal);
